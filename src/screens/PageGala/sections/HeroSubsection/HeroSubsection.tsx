...
export const HeroSubsection = (): JSX.Element => {
  ...
  if (isMobile) {
    return (
      <section className="flex flex-col w-full mt-14 h-[800px] justify-around px-6 py-20 bg-[url(/page_gala_section/gala_2025_bg.png)] bg-cover bg-[center_right_20%]">
        {/* Titre centré en haut */}
        <div className="flex flex-col items-center justify-start gap-10 text-center">
          <h1 className="font-[beautique-display-bold] text-5xl text-vanilla leading-[0.9]">GALA 2025</h1>
          <p className="font-[beautique-display] font-medium italic text-vanilla text-3xl">
        ...
        <div className="flex flex-col items-center justify-end gap-5 w-full">
          <HashLink smooth to="#billeterie_gala" className="w-full max-w-md">
            <Button className="group relative flex items-center bg-vanilla justify-between w-full rounded-[500px] shadow-[0px_1px_2px_#00000040] h-auto py-2 overflow-hidden transition-all duration-500 hover:bg-carmin">
              <span className="flex-1 text-center [font-family:'Mona_Sans',Helvetica] font-extrabold text-lg tracking-[0] leading-[35px] text-carmin group-hover:text-antiflash">
                Acheter vos places
              </span>
          ...
          <HashLink smooth to="#encheres_gala" className="w-full max-w-md">
          ...
          <HashLink smooth to="#cercle_gala" className="w-full max-w-md">
    ...
    <section className="flex flex-col w-full min-h-[1000px] justify-between px-0 py-[70px] bg-[url(/page_gala_section/gala_2025_bg.png)] bg-cover bg-[50%_50%]">
      <div className="flex justify-end px-28 py-40 w-full">
        <div className="flex flex-col items-center justify-center gap-[30px] flex-1">
          <h1 className="w-full font-[beautique-display-bold] text-vanilla text-[200px] text-right leading-[0.9]">GALA</h1>
          <h1 className="w-full font-[beautique-display-bold] text-vanilla text-[200px] text-right leading-[0.9]">2025</h1>
      ...
      <div className="flex items-start gap-5 px-[100px] py-0 w-full">
        {/* Les boutons restent en ligne pour desktop */}
