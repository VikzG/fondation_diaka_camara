...
export const PreActusSubsection = (): JSX.Element => {
  return (
    <section className="grid grid-cols-3 items-center px-20 py-14 bg-[linear-gradient(270deg,rgba(240,100,25,1)_0%,rgba(195,15,40,1)_100%)]">
      ...
      <HashLink smooth to="#actualites_home" className="justify-self-end">
        <Button className="inline-flex items-center justify-center gap-2.5 pt-[5px] pb-[7px] px-[25px] bg-antiflash rounded-[10px] text-carmin [font-family:'Mona_Sans',Helvetica] font-extrabold text-lg text-center leading-[30px] h-auto hover:underline hover:-translate-y-1 transition-all duration-300 ease-in-out">
          Voir les actualités
        </Button>
      </HashLink>
    </section>
