...
export const HeroSection = (): JSX.Element => {
  ...
  if (isMobile) {
    return (
      <section
        className="flex w-full min-h-[800px] mt-12 p-6 lg:p-20 items-start justify-center relative bg-[url('/page_presidente_section/banner_presidente.jpg')] bg-cover bg-[60%_50%] lg:mt-20"
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('/page_presidente_section/banner_presidente.jpg')`,
        }}
      >
        <div className="flex flex-col items-center gap-16 lg:gap-[100px] p-6 lg:p-[100px] relative flex-1 self-stretch grow">
          {/* Logo + titres */}
          <div className="flex flex-col items-center justify-center gap-8 lg:gap-[50px] flex-1 grow relative self-stretch w-full">
            <img
              className="relative w-[90px] h-[90px] lg:w-[114px] lg:h-[115px]"
              alt="presidente banner"
              src="/cercle_section/cercle_logo.svg"
            />

            <div className="flex flex-col items-start gap-3 lg:gap-5 relative self-stretch w-full flex-[0_0_auto]">
              <h1 className="relative self-stretch font-[beautique-display-bold] text-3xl lg:text-5xl text-vanilla text-center">
                UN MOT DE LA PRÉSIDENTE
              </h1>

              <h2 className="relative self-stretch font-[beautique-display] text-vanilla text-xl lg:text-4xl text-center tracking-[0.64px] leading-[28px] lg:leading-[38px]">
          ...
          {/* Boutons */}
          <div className="flex flex-col lg:flex-row items-stretch lg:items-start gap-6 lg:gap-[50px] relative self-stretch w-full flex-[0_0_auto]">
            ...
            <HashLink smooth to="#fondation_fondatrice" className="w-full">
              <Button className="group relative flex items-center bg-antiflash justify-between w-full rounded-[500px] shadow-[0px_1px_2px_#00000040] h-auto py-2 overflow-hidden transition-all duration-500 hover:bg-[#0A4BA5]">
                <span className="flex-1 text-center [font-family:'Mona_Sans',Helvetica] font-extrabold text-lg tracking-[0] leading-[35px] text-[#0A4BA5] group-hover:text-antiflash">
                  Les Ambitions
                </span>
  ...
  return (
    <section
      className="flex w-full min-h-[1000px] p-20 items-start justify-center relative bg-[url('/page_presidente_section/banner_presidente.jpg')] bg-cover bg-[center_top] lg:mt-20"
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/page_presidente_section/banner_presidente.jpg')`,
      }}
    >
