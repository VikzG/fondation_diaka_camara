...
export const HeroSection = (): JSX.Element => {
    ...
    if (isMobile) {
      return (
            <section className="flex w-full min-h-[800px] mt-12 p-6 lg:p-20 items-start justify-center relative bg-[url('/page_presidente_section/presidente_banner.png')] bg-cover bg-[center_top] lg:mt-20">
